/*
 * -----------------------------------------------------------------------------
 * Created by Ulysses Carlos on 08/30/2020 at 07:19 PM
 * 
 * Day18.cc
 ...
 * which reads the same backwards and forwards. Can you determine if a given string
 * s is a palindrome?
 ...
 * must dequeue the first character from the queue and pop the top character 
 ...
 *  A char popCharacter() method that pops and returns the character at 
